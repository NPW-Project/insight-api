...
describe('Transactions', function() {
  ...
  describe('/tx/:txid', function() {
    ...
    it('should have correct data', function(done) {
        ...
        'vin': [
          {
            ...
            'addr': 'NhkeYR4kGntpNA4YWJMJbws8BmH2sBdG98',
            'valueSat': 1546063700,
            'value': 15.460637,
        ...
        'vout': [
          {
            ...
            'scriptPubKey': {
              ...
              'addresses': [
                'Nd56xNU7pUZytqZ2U3odbT8TVggphojiF5'
              ],
              'type': 'pubkeyhash'
            },
            'spentHeight': null,
          ...
          },
          {
            ...
            'scriptPubKey': {
              ...
              'addresses': [
                'Ndfs2kpGvKeVBrtmeinWu1j4rkytBgiuYW'
              ],
              'type': 'pubkeyhash'
            },
            'spentHeight': null,
      ...
      var tx = npwcore.Transaction('');

      tx.__blockhash = '0000000000000000009d2e9b7a984d55c6c99ba62f98e9bc7dad8b1e779045a3';
      tx.blockhash = '0000000000000000009d2e9b7a984d55c6c99ba62f98e9bc7dad8b1e779045a3';
      tx.__height = 481763;
      tx.__inputValues = [ 1546063700 ];
      tx.__timestamp = 1503507151;
      tx.inputSatoshis = [ 1546063700 ];
      tx.feeSatoshis = 200000;
      tx.outputSatoshis = 1545863700;
      ...
      var node = {
        services: {
          ...
          transaction: {
            getDetailedTransaction: sinon.stub().callsArgWith(2, null, tx)
          }
        }
      };
  ...
  describe('/txs', function() {
    ...
    it('by block hash', function(done) {
      ...
      var tx = npwcore.Transaction('');

      tx.__blockhash = '000000006a625f06636b8bb6ac7b960a8d03705d1ace08b1a19da3fdcc99ddbd';
      tx.blockhash = '000000006a625f06636b8bb6ac7b960a8d03705d1ace08b1a19da3fdcc99ddbd';
      tx.__height = 2;
      tx.__inputValues = [ 1546063700 ];
      tx.__timestamp = 1231469744;
      tx.inputSatoshis = [ 1546063700 ];
      tx.feeSatoshis = 0;
      tx.outputSatoshis = 5000000000;
            ...
            'vout': [
              {
                ...
                'scriptPubKey': {
                  ...
                  'addresses': [
                    'NcFmPu2L4mogjC78xcCgSpm6UpC4cqPWSP'
                  ],
                  'type': 'pubkeyhash'
                },
                'spentHeight': null,
    ...
    it('by address, single/coinbase', function(done) {
      ...
      var tx = npwcore.Transaction(hex);
      tx.__height = 481411;
      tx.outputSatoshis = 1285927535;
      tx.__timestamp = 1503242912;
      tx.__blockhash = '000000000000000000926a0cd4a05ef116514cbf1852edc306d13eb951ec0b54';
      tx.blockhash = '000000000000000000926a0cd4a05ef116514cbf1852edc306d13eb951ec0b54';
            ...
            'vout': [
              {
                ...
                'scriptPubKey': {
                  ...
                  'addresses': [
                    'Nbj5txnUtv89q3TvBNZDaZNnriTHKmFDDH'
                  ],
                  'type': 'pubkeyhash'
                },
                'spentHeight': null,
      ...
      var req = {
        query: {
          address: 'y1rojMu6jdpdjnAU1UWosnuP4WEMAWLvTx'
        }
      };
    ...
    it('should give the correct data', function(done) {
      ...
      var node = {
        services: {
          ...
          transaction: {
            getTransaction: sinon.stub().callsArgWith(1, null, npwcore.Transaction(hex))
          }
        }
      };
  ...
  describe('#transformInvTransaction', function() {
    ...
    it('should give the correct data', function() {
      var insight = {
        ...
        'vout': [
          {
            '6S7N5CeQY1Lu2VedLKj6mpArmQM6UeBwM4': 45000
          },
          {
            'NMRtkXg9b1gX16QDWLbWUARVKLSFTugEuk': 1993504
          }
        ],
        'isRBF': false
      };
      ...
      var tx = npwcore.Transaction(rawTx);
    ...
    it('will not include null values in vout array', function() {
      var insight = {
        ...
        'vout': [
          {
            'yL7Rct4T2sgZvVQcmzwDpoEk4zsnca7gtZ': 12.5002 * 1e8
          }
        ],
        'isRBF': false
      };
    ...
    it('should detect RBF txs', function() {
      ...
      _.each(testCases, function(tc) {
        var tx = npwcore.Transaction(tc.rawTx);
        var result = transactions.transformInvTransaction(tx);
