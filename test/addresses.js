...
var tx = {
  ...
  outputs: [
    ...
    {
      satoshis: 53320000,
      address: 'yGD6dq7U1mwNs7M3sSCT3LJwnUXVeYXEjp',
    ...
    {
      address: 'y52RaBCLFpfbSLJ5bSDC5ZiCNsimM3UN9Q',
      satoshis: 289829,
...
var tx = npwcore.Transaction(rawHex);
tx.__blockhash = '0000000000000041ddc94ecf4f86a456a83b2e320c36c6f0c13ff92c7e75f013';
tx.blockhash = '0000000000000041ddc94ecf4f86a456a83b2e320c36c6f0c13ff92c7e75f013';
tx.__height = 534181;
tx.__timestamp = 1441116143;
tx.outputSatoshis = 53829829;
...
describe('Addresses', function() {
  ...
  describe('/addr/:addr/utxo', function() {
    it('should have correct data', function(done) {
      ...
      var req = {
        addr: 'yGD6dq7U1mwNs7M3sSCT3LJwnUXVeYXEjp'
      };
  ...
  describe('/addrs/:addrs/utxo', function() {
    ...
    it('should have the correct data', function(done) {
      ...
      var req = {
        addrs: 'yGD6dq7U1mwNs7M3sSCT3LJwnUXVeYXEjp,y52RaBCLFpfbSLJ5bSDC5ZiCNsimM3UN9Q'
      };
